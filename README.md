...
这个仓库收录了多个可以直接访问的纯前端网页工具，覆盖编程语言学习、音视频转换和高校课程复习。工具无需安装桌面软件，处理记录与用户文件默认保留在本机浏览器中。
...
- 视频输入支持 MP4、WebM、MOV、M4V、OGV、AVI 和 MKV 等浏览器可读取格式
...
- 视频转 MP4 采用浏览器播放捕获与本地录制，速度接近视频时长，大文件会占用较多内存
